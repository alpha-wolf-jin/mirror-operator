...
Fix https://access.redhat.com/solutions/5515251

Sample update from local disk to registry:
```
...
[root@bastion mirror-operator]# oc get secret pull-secret -n openshift-config --template='{{index .data ".dockerconfigjson" | base64decode}}' | jq
{
  "auths": {
    "cloud.openshift.com": {
      "auth": "b3BlbnNoaQko2Q0I5VzNFSFIzS0pSSFhOSFgyVllNMlFFMVQ=",
      "email": "rhpds-admins@redhat.com"
    },
    "quay.io": {
      "auth": "b3BlbnNoaSSFhOSFgyVllNMlFFMVQ=",
      "email": "rhpds-admins@redhat.com"
    },
    "registry.connect.redhat.com": {
      "auth": "NTE1NDg0OFFNGJkaWhfRjNGSQ==",
      "email": "rhpds-admins@redhat.com"
    },
    "registry.redhat.io": {
      "auth": "NTE1NDg0OhzVkFFNGJkaWhfRjNGSQ==",
      "email": "rhpds-admins@redhat.com"
    }
  }
}
